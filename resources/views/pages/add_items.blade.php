    ...
    <div class="col-12">
        <div class="card mb-4">
            ...
            <div class="card-body px-4 pt-0 pb-2">
                ...
                @endif
                <form id="addItemsForm" enctype="multipart/form-data" method="POST" action="{{ route('data_p3k.store') }}">
                    @csrf
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-14">
                            <input type="number" class="form-control" id="inputQuantity" placeholder="Input Quantity" name="quantity">
                        </div>
                    </div>
                    <div class="form-group ">
