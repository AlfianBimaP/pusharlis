                    ...
                    <form id="editUserForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="px-1 pt-2">
                                ...
                                <a href="{{ route('page', ['page' => 'user-management']) }}"><button class="btn btn-danger btn-sm" type="button">Cancel</button></a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Submit Edited Users</h5>
