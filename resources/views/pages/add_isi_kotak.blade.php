            ...
            <div class="card mb-4">
                ...
                <div class="card-body px-4 pt-0 pb-2">
                    ...
                    <form id="addItemsForm" enctype="multipart/form-data" method="POST"
                        action="{{ route('isi_kotak.store', $kotaks->id) }}">
                        @csrf
                        <input type="text" class="form-control" id="kotak" name="kotak" value="{{ $kotaks->id }}"
                            hidden>
                        ...
                        <div class="form-group">
                            <div class="px-1 pt-2">
                                ...
                                <a href="{{ route('isi_kotak.detail', $kotaks->id) }}"><button class="btn btn-danger btn-sm"
